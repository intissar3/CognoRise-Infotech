...
class TIC_TAC_TOE_AI:
    def __init__(self, root):
        ...
        self.window = root
        self.make_canvas = Canvas(self.window, background="#F0F8FF", relief=RAISED, bd=3)
    ...
    def decorating(self): 
        control_button_config = {"font": ("Helvetica", 15, "bold"), "bg": "#B0E0E6", "fg": "#000000", "activebackground": "#AFEEEE", "bd":0}
        
        self.machine_first_control = Button(self.make_canvas, text="Machine First", command=lambda: self.control_give("machine_first"), **control_button_config)
        self.machine_first_control.place(x=50, y=50, width=150, height=25)
        self.machine_first_control.config(fg="#000080")

        self.human_first_control = Button(self.make_canvas, text="You First", command=self.control_give, **control_button_config)
        self.human_first_control.place(x=250, y=50, width=150, height=25)
        self.human_first_control.config(fg="#000080")

        button_config = {"font": ("Helvetica", 20, "bold"), "width": 5, "height": 2, "bg": "#ADD8E6", "fg": "#000000", "activebackground": "#87CEEB", "bd": 0, "state": DISABLED}
        
        self.btn_1 = Button(self.make_canvas, text="", command=lambda: self.__human_play(1), **button_config)
        self.btn_1.place(x=70, y=100)
        self.btn_2 = Button(self.make_canvas, text="", command=lambda: self.__human_play(2), **button_config)
        self.btn_2.place(x=170, y=100)
        self.btn_3 = Button(self.make_canvas, text="", command=lambda: self.__human_play(3), **button_config)
        self.btn_3.place(x=270, y=100)

        self.btn_4 = Button(self.make_canvas, text="", command=lambda: self.__human_play(4), **button_config)
        self.btn_4.place(x=70, y=200)
        self.btn_5 = Button(self.make_canvas, text="", command=lambda: self.__human_play(5), **button_config)
        self.btn_5.place(x=170, y=200)
        self.btn_6 = Button(self.make_canvas, text="", command=lambda: self.__human_play(6), **button_config)
        self.btn_6.place(x=270, y=200)

        self.btn_7 = Button(self.make_canvas, text="", command=lambda: self.__human_play(7), **button_config)
        self.btn_7.place(x=70, y=300)
        self.btn_8 = Button(self.make_canvas, text="", command=lambda: self.__human_play(8), **button_config)
        self.btn_8.place(x=170, y=300)
        self.btn_9 = Button(self.make_canvas, text="", command=lambda: self.__human_play(9), **button_config)
        self.btn_9.place(x=270, y=300)

        self.activate_btn = [self.btn_1, self.btn_2, self.btn_3, self.btn_4, self.btn_5, self.btn_6, self.btn_7, self.btn_8, self.btn_9]
       

        self.reset_btn = Button(self.make_canvas, text="Reset", disabledforeground="grey", command=self.reset, state=DISABLED, **control_button_config)
        self.reset_btn.place(x=170, y=440)
        self.reset_btn.config(fg="#000080")
